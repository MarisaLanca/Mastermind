...
void leCaractere(string const s, char &c)
{
    while (true)
    {
        ...
        else
        {
            if(cin.peek() != '\n')
            {
                cout << endl << "        " << "Caractere ilegal! Introduza novamente a chave apenas com caracteres permitidos." << endl; 
                cout << "        ";
                cin.clear();              
                for (int i = 0; i < s.length(); i++)
                {
...
void jogar()
{
    ...
    cout << endl
         << "Introduza o número maximo de tentativas admitido (max 10): ";
    ...
    if (numTentativasMax > 0 and numTentativasMax <= 10)
    {
        ...
        {
            cout << endl
                 << "Parabeéns! É um génio do MasterMind!! :-)";
            cout << endl
...
void instrucoes()
{
    ...
    cout << "Por cada símbolo na posicao correta será exibido um '+'." << endl;
    cout << "Por cada símbolo correto na posição errada será exibido um '-'." << endl;
}
...
int main()
{
    ...
    while (1)
    {
        ...
        case 3:
            cout << endl
                 << "Obrigada por jogar MasterMind! Volte sempre!" << endl;
            return (0);            
